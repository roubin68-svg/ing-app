...
namespace IngApp.Infrastructure.Migrations
{
    ...
    [Migration("20260127171545_InitialCreate")]
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.CommissionRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 973, DateTimeKind.Utc).AddTicks(2658),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 973, DateTimeKind.Utc).AddTicks(2660),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Plan1Month",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 975, DateTimeKind.Utc).AddTicks(8608),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "Plan3Month",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 975, DateTimeKind.Utc).AddTicks(8610),
                        ...
                        new
                        {
                            Id = 3,
                            Code = "Plan6Month",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 975, DateTimeKind.Utc).AddTicks(8613),
                        ...
                        new
                        {
                            Id = 4,
                            Code = "Plan12Month",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 975, DateTimeKind.Utc).AddTicks(8615),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Pricing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountRial = 10000L,
                            Code = "UnlockContactFee",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 976, DateTimeKind.Utc).AddTicks(940),
                            Description = "هزینه یک‌باره برای نمایش اطلاعات تماس یک آگهی",
                            EffectiveFrom = new DateTime(2026, 1, 27, 17, 15, 44, 976, DateTimeKind.Utc).AddTicks(936),
                            IsActive = true,
                            Title = "هزینه باز کردن اطلاعات تماس"
                        },
                        new
                        {
                            ...
                            AmountRial = 50000L,
                            Code = "OnboardingFee",
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 976, DateTimeKind.Utc).AddTicks(942),
                            Description = "هزینه یک‌باره ثبت‌نام به عنوان تأمین‌کننده",
                            EffectiveFrom = new DateTime(2026, 1, 27, 17, 15, 44, 976, DateTimeKind.Utc).AddTicks(942),
                            IsActive = true,
                            Title = "هزینه ثبت‌نام تأمین‌کننده"
                        });
                });
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 17, 15, 44, 988, DateTimeKind.Utc).AddTicks(1020),
                            DisplayName = "علی هور",
                            IsActive = true,
