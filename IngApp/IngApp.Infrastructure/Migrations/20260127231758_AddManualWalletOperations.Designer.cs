...
namespace IngApp.Infrastructure.Migrations
{
    ...
    [Migration("20260127231758_AddManualWalletOperations")]
    partial class AddManualWalletOperations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.CommissionRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 899, DateTimeKind.Utc).AddTicks(2823),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 899, DateTimeKind.Utc).AddTicks(2825),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Plan1Month",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(500),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "Plan3Month",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(502),
                        ...
                        new
                        {
                            Id = 3,
                            Code = "Plan6Month",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(504),
                        ...
                        new
                        {
                            Id = 4,
                            Code = "Plan12Month",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(506),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Pricing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountRial = 10000L,
                            Code = "UnlockContactFee",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(2824),
                            Description = "هزینه یک‌باره برای نمایش اطلاعات تماس یک آگهی",
                            EffectiveFrom = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(2819),
                            IsActive = true,
                            Title = "هزینه باز کردن اطلاعات تماس"
                        },
                        new
                        {
                            ...
                            AmountRial = 50000L,
                            Code = "OnboardingFee",
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(2826),
                            Description = "هزینه یک‌باره ثبت‌نام به عنوان تأمین‌کننده",
                            EffectiveFrom = new DateTime(2026, 1, 27, 23, 17, 57, 902, DateTimeKind.Utc).AddTicks(2826),
                            IsActive = true,
                            Title = "هزینه ثبت‌نام تأمین‌کننده"
                        });
                });
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.VisitorCommissionRule", b =>
                {
                    ...
                    b.HasIndex("VisitorProfileId", "CommissionRuleCode")
                        .IsUnique()
                        .HasDatabaseName("IX_VisitorCommissionRule_Visitor_Code_Unique");
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 23, 17, 57, 915, DateTimeKind.Utc).AddTicks(1750),
                            DisplayName = "علی هور",
                            IsActive = true,
