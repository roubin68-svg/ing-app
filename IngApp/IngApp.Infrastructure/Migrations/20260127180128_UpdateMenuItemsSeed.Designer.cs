...
namespace IngApp.Infrastructure.Migrations
{
    ...
    [Migration("20260127180128_UpdateMenuItemsSeed")]
    partial class UpdateMenuItemsSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.CommissionRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 390, DateTimeKind.Utc).AddTicks(5614),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 390, DateTimeKind.Utc).AddTicks(5617),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Plan1Month",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(1691),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "Plan3Month",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(1696),
                        ...
                        new
                        {
                            Id = 3,
                            Code = "Plan6Month",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(1700),
                        ...
                        new
                        {
                            Id = 4,
                            Code = "Plan12Month",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(1704),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Pricing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountRial = 10000L,
                            Code = "UnlockContactFee",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(8301),
                            Description = "هزینه یک‌باره برای نمایش اطلاعات تماس یک آگهی",
                            EffectiveFrom = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(8292),
                            IsActive = true,
                            Title = "هزینه باز کردن اطلاعات تماس"
                        },
                        new
                        {
                            ...
                            AmountRial = 50000L,
                            Code = "OnboardingFee",
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(8305),
                            Description = "هزینه یک‌باره ثبت‌نام به عنوان تأمین‌کننده",
                            EffectiveFrom = new DateTime(2026, 1, 27, 18, 1, 27, 399, DateTimeKind.Utc).AddTicks(8304),
                            IsActive = true,
                            Title = "هزینه ثبت‌نام تأمین‌کننده"
                        });
                });
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 27, 18, 1, 27, 423, DateTimeKind.Utc).AddTicks(9429),
                            DisplayName = "علی هور",
                            IsActive = true,
