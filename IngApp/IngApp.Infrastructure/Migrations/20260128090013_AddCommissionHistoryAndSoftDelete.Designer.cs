...
namespace IngApp.Infrastructure.Migrations
{
    ...
    [Migration("20260128090013_AddCommissionHistoryAndSoftDelete")]
    partial class AddCommissionHistoryAndSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.CommissionRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 616, DateTimeKind.Utc).AddTicks(2483),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 616, DateTimeKind.Utc).AddTicks(2486),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Plan1Month",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(3983),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "Plan3Month",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(3986),
                        ...
                        new
                        {
                            Id = 3,
                            Code = "Plan6Month",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(3988),
                        ...
                        new
                        {
                            Id = 4,
                            Code = "Plan12Month",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(3990),
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Financial.Pricing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountRial = 10000L,
                            Code = "UnlockContactFee",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(6319),
                            Description = "هزینه یک‌باره برای نمایش اطلاعات تماس یک آگهی",
                            EffectiveFrom = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(6315),
                            IsActive = true,
                            Title = "هزینه باز کردن اطلاعات تماس"
                        },
                        new
                        {
                            ...
                            AmountRial = 50000L,
                            Code = "OnboardingFee",
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(6321),
                            Description = "هزینه یک‌باره ثبت‌نام به عنوان تأمین‌کننده",
                            EffectiveFrom = new DateTime(2026, 1, 28, 9, 0, 12, 621, DateTimeKind.Utc).AddTicks(6321),
                            IsActive = true,
                            Title = "هزینه ثبت‌نام تأمین‌کننده"
                        });
                });
            ...
            modelBuilder.Entity("IngApp.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 28, 9, 0, 12, 631, DateTimeKind.Utc).AddTicks(6053),
                            DisplayName = "علی هور",
                            IsActive = true,
